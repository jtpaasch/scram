(** Implements {!Printer}.
    ...
    The primary public function is [pprint] below. The other functions
    are mainly just here to construct and format the pretty-printable
    strings that [pprint] returns. *)
